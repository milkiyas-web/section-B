        ...
        (<motion.div
            ...
            <motion.div
                ...
                <p className="text-xs text-neutral-500">
                    Hey boss I have completed the task you gave me. Can you please check it now?
                </p>
            </motion.div>
            <motion.div
                variants={variantsSecond}
                className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center justify-end space-x-2 w-3/4 ml-auto bg-white dark:bg-black">
                <p className="text-xs text-neutral-500">Yes, I will check it now.</p>
                <div
                    className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
            </motion.div>
        </motion.div>)
...
const items = [
    {
        ...
        description: (
            <span className="text-sm">
                Efficiently organize and prioritize your tasks with our intuitive interface.
            </span>
        ),
        header: <SkeletonOne />,
    ...
    },
    {
        ...
        description: (
            <span className="text-sm">
                Monitor your project's progress with visual charts and detailed analytics.
            </span>
        ),
        header: <SkeletonTwo />,
    ...
    // },
    {
        ...
        description: (
            <span className="text-sm">
                Stay on top of your deadlines with automated reminders and scheduling tools.
            </span>
        ),
        header: <SkeletonFour />,
        className: "md:col-span-2",
        icon: <IconCalendarTime className="h-4 w-4 text-neutral-500" />,
    },
    {
        title: "Team Collaboration",
        description: (
            <span className="text-sm">
                Seamlessly work together with your team members on shared projects and tasks.
            </span>
        ),
        header: <SkeletonFive />,
        className: "md:col-span-1",
